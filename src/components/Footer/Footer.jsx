      ...
      <div className="footer__inner">
        <div className="footer__top">
          <div className="footer__main">
            ...
            />
            <p>
              Built by<span>Nikolai Bain</span>
            </p>
            <p>
          ...
          <div className="footer__desc">
            <ul className="footer__list">
              <h3 className="footer__list-header">Info</h3>
            ...
            <ul className="footer__list">
              <h3 className="footer__list-header">Admin</h3>
              <li className="footer__list-item">
                <a href="#" className="list-item__link">
                  Style Guide
                </a>
          ...
          <div className="footer__updates-form">
            <h3 className="footer__updates-form__header">Newsletter</h3>
            <div className="footer__updates-form__desc">
              <p>
            ...
            <div className="footer__form">
              ...
              />
              <span className="footer__galka"></span>
            </div>
          </div>
        </div>
        <div className="footer__bottom">
          ...
          <ul className="footer__bottom-list">
            <li className="footer__bottom-list__item">
              <svg
                width="22"
                height="22"
                viewBox="0 0 22 22"
